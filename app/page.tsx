            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardContent className="p-0">
                ...
                <div className="p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 text-white">Smart Manufacturing</h3>
                  <p className="text-gray-400 text-sm sm:text-base">Advanced robotics and AI-driven automation in manufacturing</p>
                </div>
              </CardContent>
            </Card>
